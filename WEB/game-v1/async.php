...
$sql="INSERT INTO control (idUser, correctas, incorrectas, puntaje, ejercicios, faciles, medios, dificiles) VALUES ('$user','$correctas','$incorrectas','$puntaje','$ejercicios','$facilesToString','$mediosToString','$dificilesToString')";
        ...
        if ($conexion->query($sqlEjercicios) === TRUE) {
            ...
            if($intentosCount>0){
                for($i = 1; $i <= count($intentos);$i++){
                    $sqlIntentos = "INSERT INTO intentosc (idEjercicio, intento) VALUES ('$ultimaIdEjercicios', '$intentos[$i]')";
