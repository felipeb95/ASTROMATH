...
<div class = "row" style="margin-top:70px;">
    ...
    <div class="col-md-8"> 
        <h1 class="titulo"> Tus logros </h1>
        <div class="tablita">
          <p class="textorelleno" style="text-align:center;margin-top:50px;"> Acá puedes revisar los logros que ya has alcanzado.</p>
          ...
          foreach ( $data as $dataArray ){ 
            ...
            if($dataArray['tipo'] == 'login'){
               if($dataArray['requisito'] <= $_SESSION['nLogin']) {
            ...
            if($dataArray['tipo'] == 'score'){
              if($dataArray['requisito'] <= $_SESSION['highscore']) {
                echo "<td class='titulostabla'><p class='cumplido'><img class='trofeo' src='check.svg'></p></td>";
                }else{
                  echo "<td class='titulostabla'><p class='nocumplido'><img class='trofeo' src='unchecked.svg'></p></td>";
                }
            ...
            if($dataArray['tipo'] == 'ronda'){
              if($dataArray['requisito'] <= $_SESSION['nRondas']) {
                echo "<td class='titulostabla'><p class='cumplido'><img class='trofeo' src='check.svg'></p></td>";
                }else{
                  echo "<td class='titulostabla'><p class='nocumplido'><img class='trofeo' src='unchecked.svg'></p></td>";
                }
