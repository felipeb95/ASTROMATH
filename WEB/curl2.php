...
//API URL
$url = 'http://astromathapp.000webhostapp.com/parametros.php';

//Initiate cURL.
$ch = curl_init($url);
 
//The JSON data.
$jsonData = '{"menorMultiplo": '.$menorMultiplo.',"mayorMultiplo": '.$mayorMultiplo.',"rondas": '.$rondasToJsonArray.',"porcBuenas": '.$porcBuenas.',"porcMalas": '.$porcMalas.',"setMemoria": '.$setMemoria.'}';
