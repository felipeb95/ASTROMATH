...
if ($conexion->query($sql) === TRUE) {
    ...
    for ($x = 1; $x <= $rondasCount; $x++) {
        ...
        $sqlEjercicios = "INSERT INTO teste (a, b, r, idPartida, segundos, intentos, estado, etapa) VALUES ('$a','$b','$r','$ultimaIdExperimental','$segundos','$cantidad_intentos','$estado','$etapa')";
