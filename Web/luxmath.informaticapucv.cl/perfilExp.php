...
$sql = "SELECT * FROM luxmath_users WHERE id=".$_SESSION['id'];
...
<body id="page-top" ng-app = "myapp">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll-trigger" href="#page-top">LuxMath</a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
            <li class="nav-item">
              ...
              <?php }if($_SESSION["grupo"]==1){?><a class="nav-link js-scroll-trigger" href="game-v1" target="_blank">Jugar</a><?php } ?>
            </li>
            <li class="nav-item">
