...
$sql = "SELECT * FROM luxmath_users WHERE id=".$user;
...
$sql="INSERT INTO luxmath_partida (idUser, correctas, incorrectas, puntaje, ejercicios) VALUES ('$user','$correctas','$incorrectas','$puntaje','$ejercicios')";
if ($conexion->query($sql) === TRUE) {
    ...
    for ($x = 1; $x <= $rondasCount; $x++) {
        ...
        $sqlEjercicios = "INSERT INTO luxmath_ejercicio (a, b, r, idPartida, respuesta, estado, etapa, origen, operacion) VALUES ('$a','$b','$r','$ultimaIdExperimental','$respuesta','$estado','$etapa','$origen','$operacion')";
