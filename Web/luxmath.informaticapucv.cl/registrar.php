            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 mx-auto">
                        ...
                        <form action="verifyregistrar.php" method="post">
                            <input type="text" name="nombre" class="form-control" placeholder="Nombre">
                            <br>
                            <input type="text" name="apellido" class="form-control" placeholder="Apellido">
                            <br>
                            <input type="text" name="colegio" class="form-control" placeholder="Colegio" value="SSR">
                            <br>
                            <input type="text" name="curso" class="form-control" placeholder="Curso" value="5to">
                            <br>
