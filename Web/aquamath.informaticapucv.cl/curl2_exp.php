...
//The JSON data.
$jsonData = '{"menorMultiplo": '.$menorMultiplo.',"mayorMultiplo": '.$mayorMultiplo.',"rondas": '.$rondasToJsonArray.',"porcBuenas": '.$porcBuenas.',"porcMalas": '.$porcMalas.',"setMemoria": '.$setMemoria.',"min_vel": '.$min_vel.',"max_vel": '.$max_vel.',"acel": '.$acel.',"carril": '.$carril.'}';
