...
<div class = "row" style="margin-top:70px;">
    ...
    <div class="col-md-12"> 
        ...
        <br><br>
        <a href="config.php?grupo=0"><button class="btn"><i class="fa fa-gear"></i> Configurar parámetros grupo control AstroMath</button></a>
        <br><br>
        <a href="config.php?grupo=1"><button class="btn"><i class="fa fa-gear"></i> Configurar parámetros grupo experimental AstroMath</button></a>
        <br><br>
        <a href="logout.php"><button class="btn"><i class="fa fa-gear"></i> Cerrar sesión</button></a>
        <br><br>
        </div>
    </div>
