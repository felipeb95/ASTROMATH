...
$sql = "SELECT * FROM question WHERE activa=1 ORDER BY etapa";
            ...
            <div class="container">
                <div class="row">
                    <div>
                        ...
                        <h2 class="section-heading">Preguntas</h2>
                        ...
                        <?php while($row = $result->fetch_assoc()) {?>
                            <tr>
                            <th><img style="max-width:100px;width:100%" src="<?php echo $row["url"]; ?>" /></th>
                            <td><?php echo $row["correcta"]; ?></td>
                            <td><?php echo $row["alternativas"]; ?></td>
                            <td><?php if($row["activa"]==1) echo "SI"; else echo "NO"; ?></td>
                            <td><?php echo $row["etapa"]; ?></td>
                            <td><a href="modificarPregunta.php?id=<?php echo $row["id"]; ?>"><button class="btn"><i class="fa fa-refresh"></i>Modificar</button></a></td>
                            <td><a href="eliminarPregunta.php?id=<?php echo $row["id"]; ?>"><button class="btn"><i class="fa fa-trash"></i>Eliminar</button></a></td>
                            </tr>
                        <?php } ?>
                        </tbody>
                        </table>
