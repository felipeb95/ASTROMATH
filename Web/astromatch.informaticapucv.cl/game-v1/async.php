...
if ($conexion->query($sql) === TRUE) {
    ...
    for ($x = 1; $x <= $rondasCount; $x++) {
        ...
        $sqlEjercicios = "INSERT INTO astromatch_ejercicio (correcta, segundos, idPartida, intentos, estado, origen, etapa) VALUES ('$palabra','$segundos','$ultimaIdExperimental','$cantidad_intentos','$estado','$origen','$etapa')";
